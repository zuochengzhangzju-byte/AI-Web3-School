...
![41f1dc2749c69cf86d7f26967ccacd67.jpg](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/vitalebob/images/2026-05-26-1779808716782-41f1dc2749c69cf86d7f26967ccacd67.jpg)

今天老师讲agent和钱包，群里小伙伴也聊了，agent出现幻觉可能导致金额限制失效，从而导致损失，有人说可以同时有多个agent，不同的大模型，agent同时出现幻觉的概率应该就不会那么大了，有点像概率题，一个agent出现幻觉的概率是1/5,10个agent同时出现幻觉的概率就是1/5^10，看起来确实有效降低了agent的幻觉概率，但是这应该基于10个不同的大模型，如果是同一个大模型的agent，相同的情况有可能10agent 同时出现幻觉，导致概率为1/5，而不是10次方了
<!-- DAILY_CHECKIN_2026-05-26_END -->

# 2026-05-25
<!-- DAILY_CHECKIN_2026-05-25_START -->

今天老师分享的时候我又在开车，只听了一部分，还是聊一下我最近研究的ppt agent，我在群里看到女娲skill，搜索了一下，还找到了一个叫达尔文的skill，出自同一个人花叔，在感慨skill的同时，我还发现了一个ppt的skill，准备去看看好用不，也是花叔做的，huashu-slides，准备一会去试试，微信里也找了几个skill，生成html感觉还可以，但是可编辑的pptx就不太行，而且图片的处理也存在问题，深色背景和白底图片会显得突兀，我让agent重构图片，换掉底色，会丢失一部分信息，今天有一个新的思路，改ppt的背景色，感觉融洽了
...
今天老师讲到智能合约，没有想过智能合约其实也是可以升级的，因为区块链具有不可篡改性，合约生效后如果存在漏洞，被黑客攻击损失巨大，我想的应该是测试通过后才能上区块链主网，我的理解是合约的升级应该是映射关系，原代码没有发生变化，但是它会导向新的升级版本代码，从而实现迭代
...
今天听了共学和learning，老师讲的有一点是对标招聘要求，然后让ai针对自己的情况制定针对性的学习计划，补足短板，就可以有效的进行学习，钱包的知识可能听的不是很明白，还要看一下回放，再查一下资料。hermes我还没有自己动手部署过，用cursor直接部署的，控制台我都没见过，但是以前部署过龙虾，应该是类似的
