...
正好近来接触了一些新的课题。RWKV-8（RNN+Transformer）混合框架的下一代。
...
今日在和朋友讨论agent商业的话题，他觉得中国还是更偏于情绪和营销。我还是坚持有产品和内容才能真正有价值。
...
边喝着小酒边复习着本周前面的课程。现在复习的是dragon老师的《**AI Agent 入门 —— Hermes 从 0 到 1》**

**已经成功在mac上安装完homebrew，github并完成github的授权。**

结合dragon老师说的内容先配置一个聊天工具直连，就不直接在终端里面操作命令行了。

感觉还是需要周末有些夜间的时间，边学边尝试，配点小酒就当放松。挺好的！

![Clipboard_Screenshot_1779561494.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/corinnashisi/images/2026-05-23-1779561555889-Clipboard_Screenshot_1779561494.png)
...
今日老师的讲解节奏好快，只能说跟着听完。各个方向都需要沉下心来好好的研究和填充自己的知识面。加油吧
...
![Clipboard_Screenshot_1779204526.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/corinnashisi/images/2026-05-19-1779204535220-Clipboard_Screenshot_1779204526.png)
...
参加web3开发者基础知识及框架的学习。（了解web2支付服务模型，进而了解web3资金的收付。web3钱包的类型、安全、交易生命周期、交易关键参数、交易监听逻辑、交易模拟等。）
